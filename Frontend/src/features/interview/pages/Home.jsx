...
const Home = () => {
  ...
  // 1. Add state to track the file name
  const [resumeName, setResumeName] = useState("");

  const resumeInputRef = useRef();
  const navigate = useNavigate();

  // 2. Handler to capture the file name when selected
        ...
        <div className="interview-card__body">
          ...
          <div className="panel panel--right">
            ...
            <div className="upload-section">
              ...
              {/* 3. Conditional UI inside the Dropzone */}
              <label
                className={`dropzone ${resumeName ? "dropzone--uploaded" : ""}`}
                htmlFor="resume"
              >
                {resumeName ? (
